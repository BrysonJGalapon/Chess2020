...
func TestGame(t *testing.T) {
	...
	_ = b.Move(newMove("h2", "h3"))
	_ = b.Move(newMove("a7", "a6"))
	_ = b.Move(newMove("b2", "b3"))
	_ = b.Move(newMove("c7", "c6"))
	_ = b.Move(newMove("h1", "h2"))
	_ = b.Move(newMove("d7", "d6"))
	_ = b.Move(newMove("g2", "g4"))
	_ = b.Move(newMove("d8", "b6"))
	_ = b.Move(newMove("h2", "h1"))
	_ = b.Move(newMove("c8", "g4"))
	_ = b.Move(newMove("d2", "d3"))
	_ = b.Move(newMove("b8", "d7"))
	_ = b.Move(newMove("b3", "b4"))
	_ = b.Move(newMove("g7", "g6"))
	_ = b.Move(newMove("c1", "g5"))
	_ = b.Move(newMove("d6", "d5"))
	_ = b.Move(newMove("f1", "g2"))
	_ = b.Move(newMove("g4", "f5"))
	_ = b.Move(newMove("d1", "d2"))
	_ = b.Move(newMove("f7", "f6"))
	_ = b.Move(newMove("g5", "f6"))
	_ = b.Move(newMove("b6", "b5"))
	_ = b.Move(newMove("d2", "f4"))
	_ = b.Move(newMove("f5", "e6"))
	_ = b.Move(newMove("g1", "f3"))
	_ = b.Move(newMove("d7", "f6"))
	_ = b.Move(newMove("e1", "d1"))
	_ = b.Move(newMove("e8", "f7"))
	_ = b.Move(newMove("b4", "b5"))
	_ = b.Move(newMove("g6", "g5"))
	_ = b.Move(newMove("d1", "c1"))
	_ = b.Move(newMove("a6", "b5"))
	_ = b.Move(newMove("a2", "a3"))
	_ = b.Move(newMove("a8", "a3"))
	_ = b.Move(newMove("c1", "d2"))
	_ = b.Move(newMove("h7", "h6"))
	_ = b.Move(newMove("f4", "h2"))
	_ = b.Move(newMove("e6", "d7"))
	_ = b.Move(newMove("h2", "b8"))
	_ = b.Move(newMove("f7", "g6"))
	_ = b.Move(newMove("b1", "c3"))
	_ = b.Move(newMove("a3", "a7"))
	_ = b.Move(newMove("a1", "b1"))
	_ = b.Move(newMove("f8", "g7"))
	_ = b.Move(newMove("f3", "g1"))
	_ = b.Move(newMove("a7", "a8"))
	_ = b.Move(newMove("c3", "e4"))
	_ = b.Move(newMove("c6", "c5"))
	_ = b.Move(newMove("b8", "f8"))
	_ = b.Move(newMove("h8", "h7"))
	_ = b.Move(newMove("d2", "d1"))
	_ = b.Move(newMove("g5", "g4"))
	_ = b.Move(newMove("f8", "f6"))
	_ = b.Move(newMove("e7", "f6"))
	_ = b.Move(newMove("e4", "c3"))
	_ = b.Move(newMove("f6", "f5"))
	_ = b.Move(newMove("b1", "b2"))
	_ = b.Move(newMove("a8", "a7"))
	_ = b.Move(newMove("h3", "h4"))
	_ = b.Move(newMove("a7", "a8"))
	_ = b.Move(newMove("d1", "c1"))
	_ = b.Move(newMove("a8", "a5"))
	_ = b.Move(newMove("h4", "h5"))
}
